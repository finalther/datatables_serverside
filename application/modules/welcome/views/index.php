                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <form id="search_filter">
                              <div class="col-md-3">
                                      <input type="text" class="form-control" data-column="0" id="s_nama" name="s_nama" placeholder="Filter Nama" style="float:right"/>
                              </div>
                              <div class="col-md-3">
                                      <input type="text" class="form-control" data-column="1" id="s_kategori" name="s_kategori" placeholder="Filter Kategori" style="float:right"/>
                              </div>
                              <div class="col-md-3">
                                  <button class="btn btn-primary" name="filter" id="filter" type="button"  onclick="f_filter()"><i class="glyphicon glyphicon-search"> </i> Filter</button>
                              </div>
                          </form>
                        </div>
                    <br>
...
<script type="text/javascript">
  $(document).ready( function (){
                ...
                // Edit Table
                 $('#tableku').on('click','.edit',function(){
                  ...
                  $('#tableku').on('click','.hapus',function(){
                    var kode=$(this).data('kode');
                    $.ajax({
                        url : '<?= base_url()?>index.php/welcome/hapus/'+kode,
                        type:'post',

                        success:function(s){
                          // alert("sukses");
                          // window.location.reload();
                          $("#tableku").DataTable().draw();
                        }
                    });
                });
  ...
  function f_filter(){
    ...
    $.ajax({
      url : '<?= base_url('index.php/welcome/filter')?>',
      data:form_data,
      type:'post',
