...
class Welcome extends MX_Controller {
    ...
    function json(){
        ...
        $this->datatables->add_column('view', '<a href="javascript:void(0)" data-kode="$1" data-nama="$2" data-harga="$3" data-stok="$4" data-kategori="$5" data-idkategori="$6"  class="edit btn btn-info btn-sm"> <i class="glyphicon glyphicon-pencil"></i> edit</a> <a href="javascript:void(0)" data-kode="$1" class="hapus btn btn-danger btn-sm"> <i class="glyphicon glyphicon-trash"></i> Hapus</a>','
